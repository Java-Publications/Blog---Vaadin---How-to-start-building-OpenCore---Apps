...
import eu.svenruppert.opencore.counter.enterprise.audit.AuditEntry;
import eu.svenruppert.opencore.counter.enterprise.audit.AuditLogCounterEventListener;
import eu.svenruppert.opencore.counter.enterprise.audit.AuditLogStore;
import eu.svenruppert.opencore.counter.enterprise.history.HistoryCounterEventListener;
import eu.svenruppert.opencore.counter.enterprise.history.HistoryEntry;
import eu.svenruppert.opencore.counter.enterprise.history.HistoryStore;
...
class EnterpriseEventListenerTest {
  ...
  void historyStoreClearEmpties() {
    HistoryStore store = new HistoryStore();
    store.add(new eu.svenruppert.opencore.counter.enterprise.history.HistoryEntry(
